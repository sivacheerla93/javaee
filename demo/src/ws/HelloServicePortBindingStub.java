/**
 * HelloServicePortBindingStub.java
 *
...
public class HelloServicePortBindingStub extends org.apache.axis.client.Stub implements ws.HelloService {
    ...
    public HelloServicePortBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public HelloServicePortBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public HelloServicePortBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public java.lang.String getMessage(java.lang.String name) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://ws/", "getMessage"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {name});
  ...
  throw axisFaultException;
    ...
    public java.util.Calendar getCurrentDate() throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://ws/", "getCurrentDate"));
